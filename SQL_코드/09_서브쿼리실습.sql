...
AND E.SALARY = 
(SELECT E.MAX(SALARY)FROM EMPLOYEE 
WHERE E.HIRE_DATE >= TO_DATE('2000-01-01','YYYY-MM-DD'));
...
WHERE TO_CHAR(E1.HIRE_DATE,'YYYY') = '2000'
AND E1.EMP_ID != E2.EMP_ID;
--E1이 2000년에 입사한 직원을 기준으로 동일한 부서와 직급을 가진 다른 직원 E2 찾음
--E2는 2000년에 입사한 직원과 동일한 부서 동일한 직급을 가진 다른 직원 찾기

-- 5. 77년생 여자 사원과 동일한 부서이면서 동일한 사수를 가지고 있는 사원을 조회하시오
-- 사번, 이름, 부서코드, 부서번호, 주민번호, 고용일
