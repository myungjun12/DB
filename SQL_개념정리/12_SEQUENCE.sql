...
CREATE TABLE TB_TEST (
    TEST_NO NUMBER PRIMARY KEY, -- 자료형 안쓰면 ORACLE에서 지정한 최대 값 설정 38 자리
    TEST_NAME VARCHAR2(30)NOT NULL
);

CREATE SEQUENCE SEQ_TEST_NO -- 시퀀스 괄호가 없음
...
-- 시퀀스 값 변경(ALTER)
-->CREATE 구문과 같지만 START WITH 옵션은 제외됨
/*
